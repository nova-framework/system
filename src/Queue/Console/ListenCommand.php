...
class ListenCommand extends Command
{
     ...
     *
     * @param  \Nova\Queue\Listener  $listener
     * @return void
     */
    ...
    protected function getQueue($connection)
    {
        ...
        {
            $connection = $this->nova['config']['queue.default'];
        }

        $queue = $this->nova['config']->get("queue.connections.{$connection}.queue", 'default');
    ...
    {
        $this->listener->setEnvironment($this->nova->environment());
