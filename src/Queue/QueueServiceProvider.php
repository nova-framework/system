...
use NovaQueueClosure;
use Nova\Support\ServiceProvider;
use Nova\Queue\Console\WorkCommand;
use Nova\Queue\Console\ListenCommand;
...
class QueueServiceProvider extends ServiceProvider
{
    ...
    /**
     * Register the Nova queued closure job.
     *
     * @return void
     */
    protected function registerQueueClosure()
    {
        $this->app->bindShared('NovaQueueClosure', function($app)
        {
            return new NovaQueueClosure($app['encrypter']);
        });
    }
