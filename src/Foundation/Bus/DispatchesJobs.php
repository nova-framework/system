...
trait DispatchesJobs
{
    ...
    {
        return app('Nova\Contracts\Bus\Dispatcher')->dispatch($job);
    }
    ...
    {
        return app('Nova\Contracts\Bus\Dispatcher')->dispatchFromArray($job, $array);
    }
    ...
    {
        return app('Nova\Contracts\Bus\Dispatcher')->dispatchFrom($job, $source, $extras);
    }
}
