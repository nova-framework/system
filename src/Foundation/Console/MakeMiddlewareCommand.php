...
class MakeMiddlewareCommand extends Command
{
    ...
    protected function getPath()
    {
        ...
        if (is_null($path)) {
            return $this->nova['path'] .DS .'Http' .DS .'Middleware';
        } else {
    ...
    {
        return array(
            array('name', InputArgument::REQUIRED, 'The name of the Middleware.'),
        );
    }
    ...
    {
        return array(
            array('path', null, InputOption::VALUE_OPTIONAL, 'The path where the Middleware should be stored.', null),
            array('namespace', null, InputOption::VALUE_OPTIONAL, 'The Middleware namespace.', null),
        );
    }
}
