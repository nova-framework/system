...
class RemoteManager
{
     ...
     * @return \Nova\Remote\ConnectionInterface
     */
     ...
     *
     * @param  array  $names
     * @return \Nova\Remote\MultiConnection
     */
     ...
     *
     * @param  \Nova\Remote\Connection  $connection
     * @return void
     */
    ...
    protected function getAuth(array $config)
    {
        ...
        } else if (isset($config['key']) && (trim($config['key']) != '')) {
            return array('key' => $config['key'], 'keyphrase' => $config['keyphrase']);
        } else if (isset($config['keytext']) && (trim($config['keytext']) != '')) {
