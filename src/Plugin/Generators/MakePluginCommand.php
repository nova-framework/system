...
class MakePluginCommand extends Command
{
    ...
    /**
     * Step 1: Configure plugin manifest.
     *
     * @return mixed
     */
...
return array (
    ...
    /**
     * Reset plugin cache of enabled and disabled plugins.
     */
    protected function optimizePlugins()
    {
        return $this->callSilent('plugin:optimize');
    }
